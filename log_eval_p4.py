...
comp_id = 124
scores = {
    'openai': {'persona': '"Literary Fiction Editor"', 'S': 4, 'D': 4, 'A': 4, 'R': 2, 'Q': 3.5},
    'anthropic': {'persona': '"Literary Critic"', 'S': 3, 'D': 3, 'A': 3, 'R': 2, 'Q': 3},
    'google': {'persona': '"Dr. Vivian Alistair, Narrative Architect"', 'S': 5, 'D': 5, 'A': 5, 'R': 5, 'Q': 5},
    'perplexity': {'persona': '"[Literary Fiction Craft Analyst]"', 'S': 5, 'D': 4, 'A': 5, 'R': 3, 'Q': 4.5}
}
...
conn.close()
print("Evaluations for Prompt 4 saved.")
